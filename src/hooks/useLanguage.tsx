...
export const translations = {
  en: {
    ...
    navAtelier: "Atelier",
    navPlots: "Open Plots",
    navHouses: "House for Sale",
    navArchitect: "Architect Design",
    navInteriors: "Interior Design",
    navPlans: "Plans",
    navOngoing: "Ongoing",
    navArchive: "Archive",
    navGallery: "Gallery",
  ...
  te: {
    ...
    navHome: "హోమ్",
    navAtelier: "అటెలియర్",
    navPlots: "ఓపెన్ ప్లాట్లు",
    navHouses: "ఇల్లు అమ్మకానికి",
    navArchitect: "ఆర్కిటెక్ట్ డిజైన్",
    navInteriors: "ఇంటీరియర్ డిజైన్",
    navPlans: "ప్లాన్లు",
  ...
  hi: {
    ...
    navHome: "होम",
    navAtelier: "अटेलियर",
    navPlots: "ओपन प्लॉट्स",
    navHouses: "बिक्री के लिए घर",
    navArchitect: "आर्किटेक्ट डिजाइन",
    navInteriors: "इंटीरियर डिजाइन",
    navPlans: "प्लान्स",
