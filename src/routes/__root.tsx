...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Home — Premium Plots & House Plans" },
      { name: "description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Home." },
      { name: "author", content: "Home" },
      { property: "og:title", content: "Home — Premium Plots & House Plans" },
      { property: "og:description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Home." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Home — Premium Plots & House Plans" },
      { name: "twitter:description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Home." },
