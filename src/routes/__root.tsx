...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shika's Estates — Premium Plots & House Plans" },
      { name: "description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Shika's Estates." },
      { name: "author", content: "Shika's Estates" },
      { property: "og:title", content: "Shika's Estates — Premium Plots & House Plans" },
      { property: "og:description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Shika's Estates." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Shika's Estates — Premium Plots & House Plans" },
      { name: "twitter:description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Shika's Estates." },
