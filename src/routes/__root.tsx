...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Auralis Estates — Premium Plots & House Plans" },
      { name: "description", content: "Limited-edition residential plots, bespoke house plans and signature projects from Auralis Estates." },
      { name: "author", content: "Auralis Estates" },
      { property: "og:title", content: "Auralis Estates — Premium Plots & House Plans" },
